...
const ART_H = Math.round(SCREEN_H * 0.56);

export function MenuScreen({ levelIndex, stars, onPlay, onSchemes, onTutorial }: Props) {
      ...
      <View style={styles.art}>
        <ImageBackground source={bgMenu} resizeMode="cover" style={styles.artBg}>
          ...
          <Animated.View
            ...
            <Svg width={SCREEN_W} height={ART_H}>
              <Defs>
      ...
      <Animated.View
        ...
        <View style={styles.statsRow}>
          <View style={styles.statSlot}>
            <StatCard
              dot={C.accent.teal}
              value={`${levelIndex + 1}/${TOTAL_LEVELS}`}
              label="SCHEME"
            />
          </View>
          <View style={styles.statSlot}>
            <StatCard dot={C.accent.amethyst} value={`${level.moves}`} label="MOVES" />
          </View>
          {stars > 0 ? (
            <View style={styles.statSlot}>
              <StatCard dot={C.accent.gold} value={`${stars}`} label="STARS" />
            </View>
          ) : null}
        </View>
        ...
        <PrimaryButton label="START PUZZLE" onPress={onPlay} />
        ...
        <View style={styles.secondRow}>
          ...
          <View style={styles.secondSlot}>
            <SecondaryButton label="HOW IT WORKS" Icon={BookOpen} onPress={onTutorial} />
          </View>
        </View>
      </Animated.View>
    </View>
