...
export function TutorialScreen({ onBegin, onBack }: Props) {
  return (
    <View style={styles.root}>
      ...
      />
      <DustLayer width={SCREEN_W} height={SCREEN_H} count={600} seed={90210} />
      ...
      <View style={styles.body}>
        <View style={styles.demoRow}>
          <DemoBoard />
          <Image source={spriteGem} style={styles.sprite} resizeMode="contain" />
        </View>
        ...
        <View style={styles.cta}>
          <PrimaryButton label="START LESSON" onPress={onBegin} />
        </View>
      </View>
    </View>
  );
